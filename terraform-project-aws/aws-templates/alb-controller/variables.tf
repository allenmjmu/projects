...
variable "mod_dependency" {
  default = null
  description = "Dependency variable binds all AWS resources allocated by this module, dependent modules reference this variable."
}
...
variable "kubernetes_alb_controller_policy_arn" {}

variable "aws_iam_role-kubernetes_alb_controller" {}